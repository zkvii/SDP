...
"""
Data process nsc-4 Dataset
please refer wikitext2_data_process.py
...
def preprocess_raw_data(input_file):
    """ preprocess data """
    dataset_valided = []
    count = 0
    with open(input_file, 'r', encoding='utf-8') as f:
        for line in f:
            line = line.strip()
            count+=1
            dataset_valided.append(line)
    print('read {} file finished!\n total count = {}'.format(input_file, count))

    res = []
    for line in dataset_valided:
        text = ""
...
def write_instance_to_file(writer:FileWriter, instance):
...
def main():
    ...
    dataset_valid = preprocess_raw_data(args.input_file)
